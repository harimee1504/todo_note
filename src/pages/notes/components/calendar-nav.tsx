...
import { months } from "@/pages/notes/utils/data";
import { calendarRef } from "@/pages/notes/utils/data";
...
import {
  ...
  handleYearChange,
  setView,
} from "@/pages/notes/utils/calendar-utils";
...
export default function CalendarNav({
  ...
  return (
    <div className="flex flex-wrap min-w-full justify-between gap-3">
